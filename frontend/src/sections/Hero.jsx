export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      {/* Soft gold glow */}
      <div className="absolute right-[-20%] top-[10%] w-[600px] h-[600px] bg-[#D6B46A]/20 blur-[120px] rounded-full" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-28 pb-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <h1 className="text-4xl md:text-6xl font-semibold leading-tight tracking-tight text-white">
            Fast And Simple <br />
            <span className="text-[#D6B46A] font-bold">Digital Payment</span> <br />
            Solution
          </h1>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <button className="px-6 py-3 bg-[#D6B46A] text-black font-semibold rounded-md shadow-[0_0_60px_rgba(214,180,106,0.35)]">
              Get Started
            </button>

            <button className="px-6 py-3 border border-white/20 text-white rounded-md hover:bg-white/5">
              View Dashboard
            </button>
          </div>
        ...
        <div className="relative flex justify-center">
          ...
          <div className="relative bg-[#121316] border border-white/10 rounded-2xl p-8 w-[320px] shadow-2xl">
            ...
            <p className="mt-2 text-4xl font-bold text-[#D6B46A]">92.4%</p>
          ...
          {/* Floating badge */}
          <div className="absolute -bottom-6 -right-6 bg-[#D6B46A] text-black text-sm font-semibold px-4 py-2 rounded-lg shadow-[0_0_60px_rgba(214,180,106,0.35)]">
            1.24M+ Transactions
          </div>
        </div>
      </div>
